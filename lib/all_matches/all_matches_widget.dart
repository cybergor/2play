...
import '../match_page/match_page_widget.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:google_fonts/google_fonts.dart';

class AllMatchesWidget extends StatefulWidget {
  AllMatchesWidget({Key key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20, 15, 20, 8),
              child: Row(
                mainAxisSize: MainAxisSize.max,
                children: [
                  Text(
                    ...
                    child: InkWell(
                      onTap: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => MatchPageWidget(),
                          ),
                        );
                      },
                      child: Container(
